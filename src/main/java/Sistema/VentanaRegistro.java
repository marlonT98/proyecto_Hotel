...
public class VentanaRegistro extends javax.swing.JFrame {
     ...
     */
    private Habitacion habitaciones;//objeto habitaciones=null
    private ControlHabitacion controlH;//objeto controlH=null
    
    
    public VentanaRegistro( Habitacion habita) {
        initComponents();
        this.habitaciones=habita;
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        habitaciones= new Habitacion(nombre, DNI, sexo, nacionalidad, numHabitacion, piso, diasAlojados, precio, estado, tipoHabitacion);
    ...
    public ControlHabitacion controlH( ){
        return controlH;
